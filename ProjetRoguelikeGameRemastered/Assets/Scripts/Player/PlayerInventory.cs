...
public class PlayerInventory : MonoBehaviour
{
    ...
    public class Slot
    {
        ...
        public void Assign(Item assignedItem)
        {
            ...
            Debug.Log(string.Format("Attribué {0} (type d'arme) to player.", item.name));
        }
    ...
    public int Add(WeaponData data)
    {
        ...
        else
        {
            Debug.LogWarning(string.Format(
                "Type d'arme invalide spécifié pour {0}.",
                data.name
            ));
        }
    ...
    void ApplyUpgradeOptions()
    {
        ...
        else upgradeWindow.SetUpgrades(this, availableUpgrades, 3, "Améliorer la stat de Chance pour pouvoir avoir 4 objets à choix!");
